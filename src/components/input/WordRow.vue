  ...
  <tr class="hover:bg-gray-50 transition-colors" ref="tableRow">
    ...
    <td class="px-3 py-4 text-sm text-gray-500">
      ...
      <textarea
        ...
        rows="1"
        class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 resize-none overflow-hidden"
        @input="handleInput"
        @focus="handleInput"
      ></textarea>
    </td>
